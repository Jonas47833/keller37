...
async def scenario_royal_look(cdp):
    ...
    # Spannung + Big Win: 💎 auf Walze 0-2 der Mittellinie → letzte zwei Walzen laufen laenger (tense), 💎×5 = 50 × 20 € = 1.000 € = 10× → BIG WIN (Balancing 2026-09-21, Jeder Tisch; vorher 100 × 20 = 2.000)
    ...
    record("mega: Spannung nach drei Diamanten, dann BIG WIN-Banner", tense and big and title == "BIG WIN" and res and res.get("tier") == "big" and res.get("payout") == 1000, "tense=%s big=%s title=%s res=%s" % (tense, big, title, res))
