...
FREE_SCREENS = ["hub", "slots", "blackjack", "poker", "roulette", "horses", "russian", "postman", "finance", "invest", "life", "stadt", "skills", "royal", "craps", "megaslots", "wheel", "stud", "sicbo"]

TAP_SELECTORS = [".side-tabs button", ".icon-btn", ".chip", ".bet-bar .btn", ".bet-field button", ".rcell", ".table-bar .btn", ".door", ".side-btn", ".portal", ".facade", "#pkPlayerCards .pcard", ".sb-cell"]
...
async def main():
    ...
    try:
        ...
        zones = {}
        for sc in ["hub", "royal", "craps", "megaslots", "wheel", "stud", "sicbo", "stadt"]:
        ...
        record("zone: Royal-Screens royal, Keller-Screens keller",
               all(zones[k] == "royal" for k in ["royal", "craps", "megaslots", "wheel", "stud", "sicbo"]) and zones["hub"] == "keller" and zones["stadt"] == "keller", zones)
