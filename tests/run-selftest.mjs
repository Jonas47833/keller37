...
for (const id of ['rules', 'gear-rules', 'perk-rules', 'util', 'state', 'bus', 'story-rules', 'royal-rules', 'baccarat-rules', 'gang-rules', 'story-probe', 'story-schuld', 'story-kater', 'selftest']) {
