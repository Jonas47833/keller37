...
for (const id of ['rules', 'gear-rules', 'perk-rules', 'util', 'state', 'bus', 'story-rules', 'royal-rules', 'baccarat-rules', 'poker-rules', 'stud-rules', 'sicbo-rules', 'gang-rules', 'dev-rules', 'cutscene-director', 'cutscene-cast', 'cutscene-sets', 'story-probe', 'story-schuld', 'story-kater', 'story-stash', 'selftest']) {
